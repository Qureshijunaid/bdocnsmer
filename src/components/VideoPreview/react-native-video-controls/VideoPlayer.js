...
export default class VideoPlayerPreview extends Component {
	static defaultProps = {
		...
		return (
			<TouchableWithoutFeedback
				...
				<View style={[styles.player.container, this.styles.containerStyle]}>
					...
					<View style={{
						flexDirection: 'row', width: '90%', alignSelf: 'center', justifyContent: 'space-between',
