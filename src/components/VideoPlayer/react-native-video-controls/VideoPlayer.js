...
class VideoPlayer extends Component {
   ...
   */
  _onLoadStart() {
    console.log("this.props.source onloadStart", this.props.source);
   ...
   */
  _onLoad(data = {}) {
    console.log("this.props.source onload", this.props.source);
    let state = this.state;
    //this._calculateVideoHeight(data)
    state.duration = data.duration;
    state.loading = false;
    this.setState(state);
    this.seekTo(this.props.initialPlayed)
  ...
  _calculateVideoHeight(data) {
    ...
    // if (width >= height) {
    //   console.log("if if width,height", width, height);
    ...
    //   this.setState(state);
    // } else {
    //   console.log("else else width,height", width, height);
      ...
      <TouchableWithoutFeedback
        ...
        <View style={[styles.player.container, this.styles.containerStyle, {
          ...
          {this.renderLoader()}
          {
            ...
            <TouchableOpacity
              activeOpacity={0.8}
              style={styles.customAudio.crossContainer}
              hitSlop={styles.customAudio.hitSlop}
              onPress={() => {
          ...
          }
          {
            this.state.showControls &&
            <>
              <View style={styles.customAudio.pausePlayContainer}>
                <TouchableOpacity
                  style={styles.customAudio.prevnextButton}
                ...
                <TouchableOpacity
                  ...
                  style={styles.customAudio.pauseButton}
                  hitSlop={styles.customAudio.hitSlop}
                >
                  <Entypo
                    name={this.state.customPlay ? "controller-paus" : "controller-play"}
                    size={this.state.customPlay ? 35 : 40}
                    color={constants.Colors.color_232323}
                  />
                </TouchableOpacity>
              ...
              <View
                style={styles.customAudio.currentTimeContainer}
              >
                <Text style={{
