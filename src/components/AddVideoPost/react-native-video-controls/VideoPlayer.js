...
import { changeVideoNewPostHandleToggleFunc } from '../../../actions/newPost';
...
class VideoPlayer extends Component {
  ...
  _onLoadStart() {
    ...
    if (this.props.paused) {
      state.customPlay = false;
    } else {
      state.customPlay = true;
    }
    this.setState(
      state
      , () => { })
  ...
  _onLoad(data = {}) {
    ...
    // const heightScaled = height / width * VIDEO_WIDTH // height * (VIDEO_WIDTH / width);
    // state.videoHeight = heightScaled
    ...
    return this.props.durationCallback(data.duration)
  }
  ...
  _calculateVideoHeight(data) {
    ...
    switch (this.props.aspectType) {
      ...
      case "34":
        videoHeight = WIDTH - 60
        break;

      case "169":
        videoHeight = 0.29 * HEIGHT
        break;

      case "916":
        videoHeight = 0.8 * HEIGHT
        break;
  ...
  _onEnd() {
    ...
    if (this.state.isForward) {
      ...
      this.setState({ customPlay: false, loadStarted: false, isForward: false }, () => { }
      );
    }
    else {

      this.seekTo(0)
      this.setState({ customPlay: true, loadStarted: false }, () => { }
      );
    }
  }
  handleForward() {
    if (this.state.duration - this.state.currentTime > 10) {
  ...
  _togglePlayPause() {
    if (this.state.isVideoEnded) {
      ...
      this.setState({ showSeker: !this.state.showSeker, customPlay: !this.state.customPlay })
      this.setState({
  ...
  renderSeekbar() {
    return (this.state.showSeker &&
      <View
        style={[styles.seekbar.container, { backgroundColor: 'red' }]}
        collapsable={false}
        {...this.player.seekPanResponder.panHandlers}>
        <View
          style={[styles.seekbar.track, { backgroundColor: 'blue' }]}
          onLayout={event =>
      ...
      <TouchableWithoutFeedback
        ...
        <View style={[styles.player.container, this.styles.containerStyle, {
          ...
          <Video
            ...
            paused={this.state.paused ? this.state.paused : !this.state.customPlay}
            ...
            onBuffer={() => {
              console.log("video is buffering component");
            }}
          // repeat={true}
          // fullscreen={true}
          />
          ...
          {/* {this.renderBottomControls()} */}
          {
            ...
            <View style={{
              ...
              bottom: 10,
              zIndex: 10,
              //right: constants.vw(40),
              bottom: constants.vh(32),
              alignItems: 'center'

            }}>
              <View style={{
                width: constants.vw(60),
                height: constants.vh(20), borderRadius: constants.vw(100),
                backgroundColor: 'black',
                alignItems: 'center',
                justifyContent: 'center',
                marginTop: 35, marginStarts: 20
              }}>
                <Text style={{
                ...
                }}>{this.formatTime(this.state.currentTime)}</Text>

              </View>
              <TouchableOpacity
                onPress={this.methods.togglePlayPause}
                style={styles.customAudio.playPauseContainer}
              >
                {
                  !this.state.customPlay ?
                    <View >
                      <Image
                        source={
                          constants.Images.Play
                    ...
                    <View style={{
                      // zIndex:100,
                      // position: 'absolute',
                      marginRight: constants.vw(40),
                      // bottom: constants.vh(32),
                      flexDirection: "row",
                      alignSelf: 'center',
                      alignItems: "center",
                      width: constants.vw(210),
                      justifyContent: "space-between",
                    }}>
                      <View
                        style={{
                      ...
                      <View style={{
                        height: constants.vw(55), width: constants.vw(55), borderRadius: constants.vw(55) / 2,
                        borderWidth: 1,
                        ...
                        <Image
                          ...
                          style={{ height: constants.vh(20), width: constants.vw(20) }}
                          resizeMode={"cover"}
                        />
                      </View>
          ...
          {(this.state.showControls && this.state.showController) &&
            <View
            ...
            >
              <View
                style={[styles.seekbar.track, { backgroundColor: "#fff" }]}
                onLayout={event =>
                  (this.player.seekerWidth = event.nativeEvent.layout.width)
                }
                pointerEvents={'none'}
          ...
          {
            !this.props.showPostActionButton &&
            <View style={styles.controls.postVideoActionButton}>
              <Components.PostActionButton
                showFull
                onPressFull={() => {
                  this.props.onPressFullScreen(this.state.currentTime)
                }}
                // isLiked={false}
                isLiked={this.props.isLiked}
                onPressLikeUnlike={this.props.onPressLikeUnlike}
