                        ...
                        <TouchableOpacity
                            ...
                            <View style={{
                                ...
                                <FastImage
                                    ...
                                    style={{
                                        width: Platform.OS == "ios" ? constants.vw(33) : constants.vw(33),
                                        height: Platform.OS == "ios" ? constants.vw(33) : constants.vw(33),
                                        borderRadius: Platform.OS == "ios" ? constants.vw(17) : constants.vw(33 / 2),
                                    }}
                                    resizeMode={FastImage.resizeMode.cover}
                                    onLoadStart={() => { }}
                                    onProgress={(e) => { }}
                ...
                <View style={styles.secondryDataContainer}>
                    <View style={styles.descriptionContainer}>
                        <View style={{
                            ...
                            {
                                !isVideo &&
                                <Text numberOfLines={1} style={[styles.text16900]}>{title}</Text>
                            }
